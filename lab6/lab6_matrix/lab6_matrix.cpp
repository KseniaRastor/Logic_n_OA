...
void Output_matrix(int** G1, int n) {					//вывод кольцевой суммы
	int col_one;
	int isolate_top[10];
	int flag = 0;
	int flag_j = 0;
...
int main() {
	...
	srand(time(0));
	for (int i = 0; i < min_n; i++) {				//формирование матрицы смежности М1
	...
	for (int i = 0; i < max_n; i++) {				//формирование матрицы смежности М2
